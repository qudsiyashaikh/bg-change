...
const [ color, setColor] = useState ("teal")
  ...
  return (
    ...
    <div className="fixed flex-grow justify-center bottom-15 inset-x-11 px-21">
<div className="flex flex-wrap justify-center gap-3 shadow-black bg-slate-500 py-3 rounded-3xl">
...
<button  onClick={() => setColor("maroon")} className="outline-none px-4 py-1 rounded-full text-black shadow-lg"
